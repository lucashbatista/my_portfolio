...
Welcome to my data analytics portfolio. My approach centers on transforming complex data into clear, measurable business value.

Each project below showcases my **end-to-end analytical process**, spanning rigorous data cleaning and statistical modeling, through to actionable recommendations.
